...
export const AUGMENTS: AugmentDef[] = [
    ...
    // ═══ 유틸 증강 (Utility) ═══
    {
        id: 'aug_interest_king', name: '이자왕', emoji: '💰',
        minRound: 10,
        effect: '이자 상한 +3 (최대 8), 이자율 10골드당→8골드당'
    },
    {
        id: 'aug_reroll_master', name: '리롤 마스터', emoji: '🎲',
        minRound: 10,
        effect: '리롤 비용 2→1, 상점 슬롯 +1 (6칸)'
    },
    {
        id: 'aug_xp_boost', name: '빠른 성장', emoji: '📈',
        minRound: 10,
        effect: '라운드당 XP +2 추가, XP 구매 시 +3 추가 XP'
    },
    {
        id: 'aug_heal', name: '재생의 오라', emoji: '💚',
        minRound: 20,
        effect: '매 라운드 HP +5 회복, 최대 HP +20'
    },
    {
        id: 'aug_gold_rush', name: '골드 러시', emoji: '🏆',
        minRound: 20,
        effect: '킬 골드 +1, 라운드 기본 수입 +3'
    },
    {
        id: 'aug_lucky', name: '행운의 주사위', emoji: '🍀',
        minRound: 30,
        effect: '상점에서 한 단계 높은 코스트 유닛 출현확률 +15%'
    },

    // ═══ 전략 증강 (Strategy) ═══
    {
        id: 'aug_double_slot', name: '차원의 문', emoji: '🌀',
        minRound: 20,
        effect: '보드 한 칸에 유닛 2마리 배치 가능(1칸만)'
    },
    {
        id: 'aug_extra_slot', name: '진격력', emoji: '📶',
        minRound: 20,
        effect: '보드 배치 슬롯 +1'
    },
    {
        id: 'aug_bench_expand', name: '대기석 확장', emoji: '🪑',
        minRound: 10,
        effect: '벤치 슬롯 +3 (최대 12)'
    },
    {
        id: 'aug_synergy_amp', name: '시너지 증폭기', emoji: '🔊',
        minRound: 30,
